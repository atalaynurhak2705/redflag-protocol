...
// V5.0 Renk Paleti (Dashboard ile Uyumlu)
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // --- YÖNLENDİRME (PARAMETRESİZ) ---
  void _navigateToDashboard() {
    // HATA BURADAYDI: Artık parametre (puan, isim vb.) göndermiyoruz.
    // Dashboard açılınca kendi verisini kendisi çekecek.
